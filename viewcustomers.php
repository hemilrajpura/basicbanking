...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
	...
	<title>Banking solutions - View Customers</title>	
	<style>
...
<header class="header-vc">
	<div class="container">
		...
		<div class="header-mid-vc">
			...
			<ul class="path-vc">
            <li><a href="index.html">Home</a></li>
            <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>View Customers</li>
        	</ul>
			</div>
				<!--  path end -->
						...
						while($row = mysqli_fetch_array($log1)){
								...
								$output = '
					             <tr><td>'.$row['customerName'].'</td>
								  ...
								  <td>
	 <button class="btn-tn trans" name="trans" id='.$row["customerID"].'>Transfer Now</button></td><tr>';
									echo $output;	
					        } 
						} 
						?>  
