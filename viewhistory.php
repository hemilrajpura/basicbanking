...
<!--   View Customer end -->
		...
		<div class="mid-stable">
				...
				<table class="customer-table">
					...
					//Sender name
				$qry2="select (customerName) from customers WHERE customerID='".$r['transactionSender']." '";
						$log2=mysqli_query($c,$qry2);
                        $row = mysqli_fetch_array($log2);
					    $sn= $row['customerName'];    	     	
					//Receiver name	
				$qry3="select (customerName) from customers WHERE customerID='".$r['transactionReceiver']." '";
						$log3=mysqli_query($c,$qry3);
